...
/// - `commands`     -- CLI commands, scripts, one-liners worth remembering
...
/// - `rules`        -- coding rules, lint policies, naming conventions
/// - `contracts`    -- API contracts, data schemas, interface guarantees
/// - `conventions`  -- team conventions, workflow norms, process agreements
/// - `templates`    -- reusable file/component templates
///
...
impl Profile for CodingProfile {
    ...
    fn seed_files(&self) -> Vec<(&str, &str)> {
        vec![
            ...
            ("commands/commands.md", SEED_COMMANDS),
            ...
            ("rules/rules.md", SEED_RULES),
            ("contracts/contracts.md", SEED_CONTRACTS),
            ("conventions/conventions.md", SEED_CONVENTIONS),
            ("templates/templates.md", SEED_TEMPLATES),
        ]
    }

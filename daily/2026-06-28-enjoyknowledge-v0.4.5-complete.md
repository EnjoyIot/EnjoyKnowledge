...
Enjoy 在 v0.4.4 完工后从 5 选项选 K1 = **立刻 v0.4.5 加 `ek kind add/rm/list`**。
...
R1 之前 v0.4.3 完工时给 5 选项 → v0.4.4 完工时给 5 选项 → **这次 Enjoy K1 拍板 R1 立刻做** = **不脑补 = 不拖延**。
